...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup-luks/files/Attic/dm-crypt-start.sh,v 1.2 2005/06/15 09:53:25 strerror Exp $
