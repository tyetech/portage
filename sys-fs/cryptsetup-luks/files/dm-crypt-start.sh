...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup-luks/files/Attic/dm-crypt-start.sh,v 1.1 2005/06/01 23:10:17 strerror Exp $
