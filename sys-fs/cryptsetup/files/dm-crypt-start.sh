...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup/files/Attic/dm-crypt-start.sh,v 1.5 2005/05/21 06:10:25 vapier Exp $
