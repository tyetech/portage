...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup/files/Attic/dm-crypt-start.sh,v 1.2 2005/03/02 15:16:39 vapier Exp $
