...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup/files/Attic/dm-crypt-start.sh,v 1.1 2005/03/01 23:25:14 azarah Exp $
