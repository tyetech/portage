...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup/files/Attic/dm-crypt-start.sh,v 1.6 2006/04/12 02:52:43 vapier Exp $
