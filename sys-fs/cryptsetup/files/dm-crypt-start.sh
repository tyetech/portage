...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/cryptsetup/files/Attic/dm-crypt-start.sh,v 1.4 2005/05/20 04:03:12 vapier Exp $
