...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-fs/cvs-repo/gentoo-x86/sys-fs/lvm2/Attic/lvm2-2.02.28-r5.ebuild,v 1.1 2008/01/30 14:37:05 cardoe Exp $
...
src_unpack() {
	unpack ${A}
	epatch "${FILESDIR}"/lvm.conf-2.02.28-r3.patch
}
