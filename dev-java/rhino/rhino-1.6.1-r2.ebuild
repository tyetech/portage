...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-java/cvs-repo/gentoo-x86/dev-java/rhino/Attic/rhino-1.6.1-r2.ebuild,v 1.5 2007/02/13 19:00:57 betelgeuse Exp $

inherit java-pkg eutils

MY_P="rhino1_6R1"
DESCRIPTION="Rhino is an open-source implementation of JavaScript written in Java."
