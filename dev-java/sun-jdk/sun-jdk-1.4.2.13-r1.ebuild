...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-java/cvs-repo/gentoo-x86/dev-java/sun-jdk/Attic/sun-jdk-1.4.2.13-r1.ebuild,v 1.1 2007/03/03 20:07:29 betelgeuse Exp $
...
src_install() {
	...
	pax-mark m $(list-paxables "${D}"/opt/${P}/{,/jre}/bin/*)
