...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-java/cvs-repo/gentoo-x86/dev-java/ibm-jre-bin/Attic/ibm-jre-bin-1.4.1-r1.ebuild,v 1.1 2004/05/29 12:03:34 dholm Exp $
IUSE="doc"
