...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-java/cvs-repo/gentoo-x86/dev-java/libmatthew-java/libmatthew-java-0.7.2.ebuild,v 1.2 2010/04/05 15:27:31 phajdan.jr Exp $
