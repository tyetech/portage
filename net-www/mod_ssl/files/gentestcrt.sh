#!/bin/sh
## $Header: /usr/local/ssd/gentoo-x86/output/net-www/cvs-repo/gentoo-x86/net-www/mod_ssl/files/Attic/gentestcrt.sh,v 1.3 2004/07/18 04:25:08 dragonheart Exp $
##
