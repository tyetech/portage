#!/bin/sh
## $Header: /usr/local/ssd/gentoo-x86/output/net-www/cvs-repo/gentoo-x86/net-www/apache/files/2.0.49/Attic/gentestcrt.sh,v 1.2 2004/07/18 04:20:47 dragonheart Exp $
##
