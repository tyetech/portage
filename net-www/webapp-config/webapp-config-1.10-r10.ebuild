...
# $Header: /usr/local/ssd/gentoo-x86/output/net-www/cvs-repo/gentoo-x86/net-www/webapp-config/Attic/webapp-config-1.10-r10.ebuild,v 1.6 2004/09/03 22:29:13 kloeri Exp $
