...
# $Header: /usr/local/ssd/gentoo-x86/output/sec-policy/cvs-repo/gentoo-x86/sec-policy/selinux-apache/Attic/selinux-apache-2.20110726-r1.ebuild,v 1.2 2011/10/23 12:43:02 swift Exp $
IUSE="kerberos"
MODS="apache"
