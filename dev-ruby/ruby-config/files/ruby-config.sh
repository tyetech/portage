...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-ruby/cvs-repo/gentoo-x86/dev-ruby/ruby-config/files/Attic/ruby-config.sh,v 1.2 2004/01/30 07:50:34 usata Exp $
