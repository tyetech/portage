...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-ruby/cvs-repo/gentoo-x86/dev-ruby/ruby-config/files/Attic/ruby-config.sh,v 1.1 2004/01/29 18:02:15 usata Exp $
