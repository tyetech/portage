...
# $Header: /usr/local/ssd/gentoo-x86/output/net-libs/cvs-repo/gentoo-x86/net-libs/libsoup/Attic/libsoup-2.34.1.ebuild,v 1.1 2011/04/29 18:09:29 nirbheek Exp $
...
LICENSE="LGPL-2"
SLOT="2.4"
KEYWORDS="~amd64 ~x86 ~x86-fbsd ~x86-freebsd ~amd64-linux ~x86-linux ~ppc-macos ~x64-macos ~x86-macos ~sparc-solaris ~x86-solaris"
