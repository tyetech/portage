...
# $Header: /usr/local/ssd/gentoo-x86/output/app-admin/cvs-repo/gentoo-x86/app-admin/dosfstools/Attic/dosfstools-2.7.ebuild,v 1.2 2001/08/27 02:13:12 drobbins Exp $
S=${WORKDIR}/${P}
