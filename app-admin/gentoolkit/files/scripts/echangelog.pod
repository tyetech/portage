...
parsed from skel.ebuild.
  ...
  +# $Header: /usr/local/ssd/gentoo-x86/output/app-admin/cvs-repo/gentoo-x86/app-admin/gentoolkit/files/scripts/Attic/echangelog.pod,v 1.1 2003/04/27 19:39:39 agriffis Exp $
  +
