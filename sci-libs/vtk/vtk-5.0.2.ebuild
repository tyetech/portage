...
# $Header: /usr/local/ssd/gentoo-x86/output/sci-libs/cvs-repo/gentoo-x86/sci-libs/vtk/Attic/vtk-5.0.2.ebuild,v 1.1 2006/12/02 15:01:23 markusle Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-5.0.1-python2.5-gentoo.patch
}
