...
# $Header: /usr/local/ssd/gentoo-x86/output/app-emulation/cvs-repo/gentoo-x86/app-emulation/dosemu/Attic/dosemu-1.1.3.ebuild,v 1.1 2002/05/18 20:14:45 rphillips Exp $
S=${WORKDIR}/${P}
