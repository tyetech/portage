...
# $Header: /usr/local/ssd/gentoo-x86/output/app-emulation/cvs-repo/gentoo-x86/app-emulation/dosemu/Attic/dosemu-1.1.3.ebuild,v 1.2 2002/07/11 06:30:12 drobbins Exp $
S=${WORKDIR}/${P}
