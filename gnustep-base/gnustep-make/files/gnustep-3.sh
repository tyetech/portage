...
# $Header: /usr/local/ssd/gentoo-x86/output/gnustep-base/cvs-repo/gentoo-x86/gnustep-base/gnustep-make/files/gnustep-3.sh,v 1.1 2010/03/09 18:52:56 grobian Exp $
