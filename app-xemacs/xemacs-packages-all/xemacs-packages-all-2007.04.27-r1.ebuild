...
# $Header: /usr/local/ssd/gentoo-x86/output/app-xemacs/cvs-repo/gentoo-x86/app-xemacs/xemacs-packages-all/xemacs-packages-all-2007.04.27-r1.ebuild,v 1.3 2008/06/26 15:57:40 coldwind Exp $
