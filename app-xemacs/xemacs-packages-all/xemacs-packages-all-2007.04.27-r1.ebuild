...
# $Header: /usr/local/ssd/gentoo-x86/output/app-xemacs/cvs-repo/gentoo-x86/app-xemacs/xemacs-packages-all/xemacs-packages-all-2007.04.27-r1.ebuild,v 1.1 2008/06/15 09:25:03 graaff Exp $
