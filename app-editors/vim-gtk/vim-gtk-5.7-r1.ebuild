...
# $Header: /usr/local/ssd/gentoo-x86/output/app-editors/cvs-repo/gentoo-x86/app-editors/vim-gtk/Attic/vim-gtk-5.7-r1.ebuild,v 1.2 2000/08/16 04:37:53 drobbins Exp $
