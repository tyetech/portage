...
# $Header: /usr/local/ssd/gentoo-x86/output/media-sound/cvs-repo/gentoo-x86/media-sound/teamspeak2-server-bin/Attic/teamspeak2-server-bin-2.0.19.40.ebuild,v 1.2 2003/12/10 18:32:06 vapier Exp $
