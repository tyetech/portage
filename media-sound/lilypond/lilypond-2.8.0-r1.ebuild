...
# $Header: /usr/local/ssd/gentoo-x86/output/media-sound/cvs-repo/gentoo-x86/media-sound/lilypond/Attic/lilypond-2.8.0-r1.ebuild,v 1.10 2007/01/10 19:49:00 peper Exp $
...
RDEPEND=">=dev-scheme/guile-1.6.5
	virtual/ghostscript
	virtual/tetex
