...
# $Header: /usr/local/ssd/gentoo-x86/output/media-sound/cvs-repo/gentoo-x86/media-sound/teamspeak-server-bin/teamspeak-server-bin-3.0.5.ebuild,v 1.1 2012/05/10 20:14:34 trapni Exp $
