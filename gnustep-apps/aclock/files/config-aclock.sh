...
# $Header: /usr/local/ssd/gentoo-x86/output/gnustep-apps/cvs-repo/gentoo-x86/gnustep-apps/aclock/files/Attic/config-aclock.sh,v 1.2 2004/09/28 00:50:15 swegener Exp $
