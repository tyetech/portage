...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-libs/cvs-repo/gentoo-x86/x11-libs/gtk-server/Attic/gtk-server-2.0.5.ebuild,v 1.1 2005/12/11 00:27:38 mkennedy Exp $
