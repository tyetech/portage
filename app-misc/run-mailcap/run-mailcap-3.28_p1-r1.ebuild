...
# $Header: /usr/local/ssd/gentoo-x86/output/app-misc/cvs-repo/gentoo-x86/app-misc/run-mailcap/Attic/run-mailcap-3.28_p1-r1.ebuild,v 1.7 2005/05/06 03:30:00 swegener Exp $
