...
# $Header: /usr/local/ssd/gentoo-x86/output/app-misc/cvs-repo/gentoo-x86/app-misc/run-mailcap/Attic/run-mailcap-3.23_p1-r1.ebuild,v 1.2 2003/12/29 02:55:53 twp Exp $
