...
# $Header: /usr/local/ssd/gentoo-x86/output/app-misc/cvs-repo/gentoo-x86/app-misc/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.3 2002/06/01 00:04:31 bass Exp $
S=${WORKDIR}/${P}
