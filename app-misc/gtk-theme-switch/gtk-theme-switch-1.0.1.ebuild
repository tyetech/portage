...
# $Header: /usr/local/ssd/gentoo-x86/output/app-misc/cvs-repo/gentoo-x86/app-misc/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.4 2002/06/01 08:47:01 blocke Exp $
S=${WORKDIR}/${P}
