...
# $Header: /usr/local/ssd/gentoo-x86/output/app-misc/cvs-repo/gentoo-x86/app-misc/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.1 2002/05/09 18:35:17 bass Exp $
S=${WORKDIR}/${P}
