...
# $Header: /usr/local/ssd/gentoo-x86/output/net-misc/cvs-repo/gentoo-x86/net-misc/bo2k_console/Attic/bo2k_console-0.0.2_pre.ebuild,v 1.3 2004/10/14 20:11:51 dholm Exp $
MY_PV="0.0.2pre"
MY_P="${PN}-${MY_PV}"
