...
# $Header: /usr/local/ssd/gentoo-x86/output/net-misc/cvs-repo/gentoo-x86/net-misc/bo2k_console/Attic/bo2k_console-0.0.2_pre.ebuild,v 1.1 2003/09/11 12:33:44 lordvan Exp $
MY_PV="0.0.2pre"
MY_P="${PN}-${MY_PV}"
