...
# $Header: /usr/local/ssd/gentoo-x86/output/app-cdr/cvs-repo/gentoo-x86/app-cdr/dvd+rw-tools/Attic/dvd+rw-tools-5.13.4.7.4.ebuild,v 1.5 2004/02/09 19:12:11 gustavoz Exp $
