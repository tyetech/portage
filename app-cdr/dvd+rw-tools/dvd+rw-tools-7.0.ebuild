...
# $Header: /usr/local/ssd/gentoo-x86/output/app-cdr/cvs-repo/gentoo-x86/app-cdr/dvd+rw-tools/Attic/dvd+rw-tools-7.0.ebuild,v 1.5 2006/12/04 11:34:34 metalgod Exp $
