...
# $Header: /usr/local/ssd/gentoo-x86/output/app-cdr/cvs-repo/gentoo-x86/app-cdr/dvd+rw-tools/Attic/dvd+rw-tools-7.0.ebuild,v 1.4 2006/12/04 00:17:25 weeve Exp $
