...
# $Header: /usr/local/ssd/gentoo-x86/output/app-arch/cvs-repo/gentoo-x86/app-arch/mt-st/Attic/mt-st-0.7-r1.ebuild,v 1.6 2004/06/06 14:38:50 dragonheart Exp $
