...
# $Header: /usr/local/ssd/gentoo-x86/output/gnome-extra/cvs-repo/gentoo-x86/gnome-extra/gpointing-device-settings/Attic/gpointing-device-settings-1.5.1-r1.ebuild,v 1.2 2011/03/30 11:09:42 angelos Exp $
