...
# $Header: /usr/local/ssd/gentoo-x86/output/gnome-extra/cvs-repo/gentoo-x86/gnome-extra/gpointing-device-settings/Attic/gpointing-device-settings-1.5.1.ebuild,v 1.2 2010/05/30 11:01:58 hwoarang Exp $
