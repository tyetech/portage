...
# $Header: /usr/local/ssd/gentoo-x86/output/gnome-extra/cvs-repo/gentoo-x86/gnome-extra/gpointing-device-settings/Attic/gpointing-device-settings-1.5.1.ebuild,v 1.4 2011/02/13 12:39:54 pacho Exp $
