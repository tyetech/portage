...
# $Header: /usr/local/ssd/gentoo-x86/output/gnome-extra/cvs-repo/gentoo-x86/gnome-extra/gpointing-device-settings/Attic/gpointing-device-settings-1.3.2.ebuild,v 1.2 2009/10/15 09:22:13 ssuominen Exp $
