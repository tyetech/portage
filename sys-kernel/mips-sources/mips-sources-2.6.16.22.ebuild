...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-kernel/cvs-repo/gentoo-x86/sys-kernel/mips-sources/Attic/mips-sources-2.6.16.22.ebuild,v 1.2 2006/07/06 05:03:45 kumba Exp $
...
GENPATCHVER="1.23"			# Tarball version for generic patches
