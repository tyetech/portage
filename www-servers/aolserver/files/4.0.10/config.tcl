...
# 
#
# $Header: /usr/local/ssd/gentoo-x86/output/www-servers/cvs-repo/gentoo-x86/www-servers/aolserver/files/4.0.10/Attic/config.tcl,v 1.1 2005/01/27 20:55:47 port001 Exp $
#
