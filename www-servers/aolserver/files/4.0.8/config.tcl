...
# 
#
# $Header: /usr/local/ssd/gentoo-x86/output/www-servers/cvs-repo/gentoo-x86/www-servers/aolserver/files/4.0.8/Attic/config.tcl,v 1.1 2004/12/19 02:56:09 port001 Exp $
#
