...
# 
#
# $Header: /usr/local/ssd/gentoo-x86/output/www-servers/cvs-repo/gentoo-x86/www-servers/aolserver/files/4.0.9/Attic/config.tcl,v 1.1 2005/01/05 19:49:09 port001 Exp $
#
