...
# $Header: /usr/local/ssd/gentoo-x86/output/app-office/cvs-repo/gentoo-x86/app-office/texmacs/texmacs-1.0.7.2-r1.ebuild,v 1.6 2011/03/23 17:07:56 xarthisius Exp $
EAPI=2
inherit autotools
MY_P=${P/tex/TeX}-src
