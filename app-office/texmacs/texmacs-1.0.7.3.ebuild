...
# $Header: /usr/local/ssd/gentoo-x86/output/app-office/cvs-repo/gentoo-x86/app-office/texmacs/Attic/texmacs-1.0.7.3.ebuild,v 1.3 2010/01/15 03:06:45 abcd Exp $
EAPI=2
inherit autotools
MY_P=${P/tex/TeX}-src
