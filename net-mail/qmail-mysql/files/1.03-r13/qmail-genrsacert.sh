#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/net-mail/cvs-repo/gentoo-x86/net-mail/qmail-mysql/files/1.03-r13/Attic/qmail-genrsacert.sh,v 1.1 2003/11/29 09:28:09 robbat2 Exp $
