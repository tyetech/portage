#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/net-mail/cvs-repo/gentoo-x86/net-mail/qmail/files/1.03-r13/Attic/qmail-genrsacert.sh,v 1.1 2003/10/27 09:42:54 robbat2 Exp $
