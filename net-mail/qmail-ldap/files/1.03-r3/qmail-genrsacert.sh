#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/net-mail/cvs-repo/gentoo-x86/net-mail/qmail-ldap/files/1.03-r3/Attic/qmail-genrsacert.sh,v 1.1 2004/01/11 07:08:52 robbat2 Exp $
