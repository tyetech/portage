#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/net-mail/cvs-repo/gentoo-x86/net-mail/qmail-ldap/files/1.03-r4/Attic/qmail-genrsacert.sh,v 1.1 2004/04/06 21:56:10 sj7trunks Exp $
