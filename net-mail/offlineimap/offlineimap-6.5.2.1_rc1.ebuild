...
# $Header: /usr/local/ssd/gentoo-x86/output/net-mail/cvs-repo/gentoo-x86/net-mail/offlineimap/Attic/offlineimap-6.5.2.1_rc1.ebuild,v 1.3 2012/04/23 20:29:38 mgorny Exp $
...
SRC_URI="mirror://github/spaetz/${PN}/${PN}-v${MYPV}.tar.gz -> ${P}.tar.gz"
