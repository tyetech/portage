...
# $Header: /usr/local/ssd/gentoo-x86/output/kde-base/cvs-repo/gentoo-x86/kde-base/konq-plugins/Attic/konq-plugins-3.4.1.ebuild,v 1.7 2005/07/06 12:46:57 greg_g Exp $
KMNAME=kdeaddons
KMNODOCS=true
MAXKDEVER=$PV
inherit kde-meta
