...
# $Header: /usr/local/ssd/gentoo-x86/output/kde-base/cvs-repo/gentoo-x86/kde-base/konq-plugins/Attic/konq-plugins-3.4.0-r1.ebuild,v 1.2 2005/04/27 21:52:20 corsair Exp $
KMNAME=kdeaddons
KMNODOCS=true
MAXKDEVER=$PV
inherit kde-meta
