...
# $Header: /usr/local/ssd/gentoo-x86/output/kde-base/cvs-repo/gentoo-x86/kde-base/kate-make/Attic/kate-make-3.4.0_beta1.ebuild,v 1.1 2005/01/15 02:24:27 danarmak Exp $
KMNAME=kdeaddons
KMNOMODULE=true
KMEXTRA="kate/make"
MAXKDEVER=$PV
