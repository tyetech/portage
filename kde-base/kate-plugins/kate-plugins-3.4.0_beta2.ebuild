...
# $Header: /usr/local/ssd/gentoo-x86/output/kde-base/cvs-repo/gentoo-x86/kde-base/kate-plugins/Attic/kate-plugins-3.4.0_beta2.ebuild,v 1.1 2005/02/11 02:08:17 caleb Exp $
KMNAME=kdeaddons
KMNOMODULE=true
KMEXTRA="kate"
MAXKDEVER=$PV
