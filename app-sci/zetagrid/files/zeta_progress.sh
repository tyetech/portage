...
# $Header: /usr/local/ssd/gentoo-x86/output/app-sci/cvs-repo/gentoo-x86/app-sci/zetagrid/files/Attic/zeta_progress.sh,v 1.3 2003/02/28 15:45:58 mholzer Exp $
