...
# $Header: /usr/local/ssd/gentoo-x86/output/app-sci/cvs-repo/gentoo-x86/app-sci/zetagrid/files/Attic/zeta_progress.sh,v 1.4 2004/07/09 21:42:18 mr_bones_ Exp $
