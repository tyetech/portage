...
# $Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.6 2005/03/02 23:44:57 azarah Exp $
...
for opt in "$@" ; do
	case ${opt} in
		...
		--version)
			cvsver="$Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/Attic/bootstrap-new.sh,v 1.6 2005/03/02 23:44:57 azarah Exp $"
			cvsver=${cvsver##*,v }
