...
# $Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.85 2007/05/14 06:22:21 kumba Exp $
...
cvsver="$Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.85 2007/05/14 06:22:21 kumba Exp $"
cvsver=${cvsver##*,v }
cvsver=${cvsver%%Exp*}
cvsyear=${cvsver#* }
cvsyear=${cvsyear%%/*}
