...
# $Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.87 2008/03/30 16:51:39 vapier Exp $
...
cvsver="$Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.87 2008/03/30 16:51:39 vapier Exp $"
cvsver=${cvsver##*,v }
cvsver=${cvsver%%Exp*}
cvsyear=${cvsver#* }
cvsyear=${cvsyear%%/*}
