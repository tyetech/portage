...
# $Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.80 2006/01/27 00:28:31 wolf31o2 Exp $
...
cvsver="$Header: /usr/local/ssd/gentoo-x86/output/scripts/cvs-repo/gentoo-x86/scripts/bootstrap.sh,v 1.80 2006/01/27 00:28:31 wolf31o2 Exp $"
cvsver=${cvsver##*,v }
cvsver=${cvsver%%Exp*}
cvsyear=${cvsver#* }
cvsyear=${cvsyear%%/*}
