...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-plugins/cvs-repo/gentoo-x86/x11-plugins/wmmon/Attic/wmmon-1.0_beta2-r1.ebuild,v 1.4 2003/01/18 08:24:25 seemant Exp $
S="${WORKDIR}/wmmon.app"
