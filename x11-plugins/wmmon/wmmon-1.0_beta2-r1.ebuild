...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-plugins/cvs-repo/gentoo-x86/x11-plugins/wmmon/Attic/wmmon-1.0_beta2-r1.ebuild,v 1.8 2003/12/06 16:00:06 port001 Exp $
S="${WORKDIR}/wmmon.app"
