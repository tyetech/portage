...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-plugins/cvs-repo/gentoo-x86/x11-plugins/wmmon/Attic/wmmon-1.0_beta2-r1.ebuild,v 1.1 2002/08/30 07:44:13 seemant Exp $
S="${WORKDIR}/wmmon.app"
