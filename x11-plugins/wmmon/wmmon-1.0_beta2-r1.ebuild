...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-plugins/cvs-repo/gentoo-x86/x11-plugins/wmmon/Attic/wmmon-1.0_beta2-r1.ebuild,v 1.5 2003/02/13 17:31:21 vapier Exp $
S="${WORKDIR}/wmmon.app"
