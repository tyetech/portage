...
# $Header: /usr/local/ssd/gentoo-x86/output/net-wireless/cvs-repo/gentoo-x86/net-wireless/iwlwifi/Attic/iwlwifi-1.2.23.ebuild,v 1.1 2008/01/22 05:08:58 compnerd Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}/${PN}-1.2.23-revert-uncompatible.patch"
}
