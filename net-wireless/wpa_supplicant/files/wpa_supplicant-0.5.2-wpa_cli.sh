...
# $Header: /usr/local/ssd/gentoo-x86/output/net-wireless/cvs-repo/gentoo-x86/net-wireless/wpa_supplicant/files/Attic/wpa_supplicant-0.5.2-wpa_cli.sh,v 1.1 2006/03/20 08:16:34 brix Exp $
