...
# $Header: /usr/local/ssd/gentoo-x86/output/net-wireless/cvs-repo/gentoo-x86/net-wireless/wpa_supplicant/files/Attic/wpa_supplicant-0.4.9-wpa_cli.sh,v 1.1 2006/05/27 20:01:35 brix Exp $
