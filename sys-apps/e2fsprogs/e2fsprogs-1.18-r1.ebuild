...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-apps/cvs-repo/gentoo-x86/sys-apps/e2fsprogs/Attic/e2fsprogs-1.18-r1.ebuild,v 1.3 2000/09/15 20:09:17 drobbins Exp $
P=e2fsprogs-1.18      
A=${P}.tar.gz
S=${WORKDIR}/${P}
