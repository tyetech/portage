...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-apps/cvs-repo/gentoo-x86/sys-apps/e2fsprogs/Attic/e2fsprogs-1.18-r1.ebuild,v 1.1 2000/08/02 17:07:12 achim Exp $
P=e2fsprogs-1.18      
A=${P}.tar.gz
S=${WORKDIR}/${P}
