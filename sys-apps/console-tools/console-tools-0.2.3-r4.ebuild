...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-apps/cvs-repo/gentoo-x86/sys-apps/console-tools/Attic/console-tools-0.2.3-r4.ebuild,v 1.14 2003/02/10 19:44:22 edolnx Exp $
