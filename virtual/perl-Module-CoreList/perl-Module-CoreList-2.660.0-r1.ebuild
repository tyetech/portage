...
# $Header: /usr/local/ssd/gentoo-x86/output/virtual/cvs-repo/gentoo-x86/virtual/perl-Module-CoreList/perl-Module-CoreList-2.660.0-r1.ebuild,v 1.1 2012/05/21 11:50:39 tove Exp $
...
RDEPEND="|| ( ~dev-lang/perl-5.16.0 ~perl-core/${PN#perl-}-${PV} )"
