...
# $Header: /usr/local/ssd/gentoo-x86/output/media-gfx/cvs-repo/gentoo-x86/media-gfx/asymptote/Attic/asymptote-1.43-r1.ebuild,v 1.1 2008/10/07 06:14:53 grozin Exp $
EAPI=2
