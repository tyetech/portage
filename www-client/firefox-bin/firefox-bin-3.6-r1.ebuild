...
# $Header: /usr/local/ssd/gentoo-x86/output/www-client/cvs-repo/gentoo-x86/www-client/firefox-bin/Attic/firefox-bin-3.6-r1.ebuild,v 1.2 2010/04/18 18:59:44 volkmar Exp $
EAPI="2"
