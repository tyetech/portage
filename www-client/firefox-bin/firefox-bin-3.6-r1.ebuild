...
# $Header: /usr/local/ssd/gentoo-x86/output/www-client/cvs-repo/gentoo-x86/www-client/firefox-bin/Attic/firefox-bin-3.6-r1.ebuild,v 1.1 2010/02/14 23:38:45 anarchy Exp $
EAPI="2"
