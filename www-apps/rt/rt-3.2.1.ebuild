...
# $Header: /usr/local/ssd/gentoo-x86/output/www-apps/cvs-repo/gentoo-x86/www-apps/rt/Attic/rt-3.2.1.ebuild,v 1.12 2007/01/20 14:42:43 mcummings Exp $
...
#	!apache2? ( =net-www/apache-1* =www-misc/libapreq-1* )
