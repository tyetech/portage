...
# $Header: /usr/local/ssd/gentoo-x86/output/www-apps/cvs-repo/gentoo-x86/www-apps/browser-config/Attic/browser-config-1.0.ebuild,v 1.2 2004/09/03 17:17:20 pvdabeel Exp $
