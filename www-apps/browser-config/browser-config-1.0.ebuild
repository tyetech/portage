...
# $Header: /usr/local/ssd/gentoo-x86/output/www-apps/cvs-repo/gentoo-x86/www-apps/browser-config/Attic/browser-config-1.0.ebuild,v 1.1 2004/08/15 09:40:44 stuart Exp $
