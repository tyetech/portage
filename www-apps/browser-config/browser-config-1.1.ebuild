...
# $Header: /usr/local/ssd/gentoo-x86/output/www-apps/cvs-repo/gentoo-x86/www-apps/browser-config/browser-config-1.1.ebuild,v 1.3 2008/02/17 19:04:46 hollow Exp $
