...
# $Header: /usr/local/ssd/gentoo-x86/output/www-apps/cvs-repo/gentoo-x86/www-apps/browser-config/browser-config-1.1.ebuild,v 1.1 2004/08/15 09:40:44 stuart Exp $
