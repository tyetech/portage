...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/xfree/files/4.2.99.902/Attic/chooser.sh,v 1.1 2003/02/25 00:20:47 seemant Exp $
