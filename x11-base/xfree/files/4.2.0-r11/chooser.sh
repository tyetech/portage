...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/xfree/files/4.2.0-r11/Attic/chooser.sh,v 1.1 2002/05/29 00:21:58 azarah Exp $
