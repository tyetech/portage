...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/xfree/files/4.2.99.3/Attic/startDM.sh,v 1.2 2002/12/07 08:45:10 seemant Exp $
