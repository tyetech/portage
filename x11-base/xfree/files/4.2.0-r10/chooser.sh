...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/xfree/files/4.2.0-r10/Attic/chooser.sh,v 1.1 2002/05/10 14:20:38 daybird Exp $
