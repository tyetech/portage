...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/xfree/files/4.3.0/Attic/chooser.sh,v 1.4 2004/07/15 01:03:31 agriffis Exp $
