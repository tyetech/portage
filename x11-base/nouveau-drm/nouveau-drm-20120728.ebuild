...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-base/cvs-repo/gentoo-x86/x11-base/nouveau-drm/nouveau-drm-20120728.ebuild,v 1.1 2012/07/31 00:27:56 chithanh Exp $
...
pkg_setup() {
	linux-mod_pkg_setup
	if kernel_is lt 3 5; then
		eerror "You need kernel 3.5 for this version of nouveau-drm"
