#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/profiles/cvs-repo/gentoo-x86/profiles/default-sparc-1.0/scripts/Attic/build-rel.sh,v 1.2 2002/08/16 14:29:29 murphy Exp $
#
