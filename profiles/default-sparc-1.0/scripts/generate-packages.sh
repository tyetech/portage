#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/profiles/cvs-repo/gentoo-x86/profiles/default-sparc-1.0/scripts/Attic/generate-packages.sh,v 1.10 2003/12/09 08:40:00 seemant Exp $
#
# New packages file
