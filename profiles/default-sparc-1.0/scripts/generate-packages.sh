#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/profiles/cvs-repo/gentoo-x86/profiles/default-sparc-1.0/scripts/Attic/generate-packages.sh,v 1.2 2002/04/16 20:37:57 murphy Exp $
#
# New packages file
