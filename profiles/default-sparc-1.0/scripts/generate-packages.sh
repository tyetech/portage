#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/profiles/cvs-repo/gentoo-x86/profiles/default-sparc-1.0/scripts/Attic/generate-packages.sh,v 1.4 2002/04/18 21:05:52 murphy Exp $
#
# New packages file
