#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/profiles/cvs-repo/gentoo-x86/profiles/default-sparc-1.0/scripts/Attic/generate-packages.sh,v 1.7 2002/05/08 01:23:05 murphy Exp $
#
# New packages file
