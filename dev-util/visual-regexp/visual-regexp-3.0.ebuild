...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-util/cvs-repo/gentoo-x86/dev-util/visual-regexp/visual-regexp-3.0.ebuild,v 1.4 2004/06/25 02:50:05 agriffis Exp $
