...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-util/cvs-repo/gentoo-x86/dev-util/tla/Attic/tla-1.2-r2.ebuild,v 1.8 2006/01/07 01:56:43 arj Exp $
...
src_install () {
	...
	cp -pPR "${WORKDIR}/${MY_P}/src/tla/=gpg-check.awk" "${D}/usr/bin/tla-gpg-check.awk"
}
