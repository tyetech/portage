...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-themes/cvs-repo/gentoo-x86/x11-themes/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.8 2003/03/27 05:28:19 vladimir Exp $
S=${WORKDIR}/${P}
