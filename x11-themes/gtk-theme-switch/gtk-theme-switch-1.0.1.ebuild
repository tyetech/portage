...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-themes/cvs-repo/gentoo-x86/x11-themes/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.6 2003/02/13 17:42:24 vapier Exp $
S=${WORKDIR}/${P}
