...
# $Header: /usr/local/ssd/gentoo-x86/output/x11-themes/cvs-repo/gentoo-x86/x11-themes/gtk-theme-switch/Attic/gtk-theme-switch-1.0.1.ebuild,v 1.9 2003/09/06 07:28:56 msterret Exp $
S=${WORKDIR}/${P}
