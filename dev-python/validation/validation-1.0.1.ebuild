...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/validation/Attic/validation-1.0.1.ebuild,v 1.2 2003/10/11 08:54:44 robbat2 Exp $
SLOT="0"
IUSE=""
