...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/validation/Attic/validation-1.2.3.ebuild,v 1.4 2006/04/01 19:18:00 agriffis Exp $
SLOT="0"
IUSE=""
