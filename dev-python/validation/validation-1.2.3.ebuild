...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/validation/Attic/validation-1.2.3.ebuild,v 1.2 2004/03/22 22:26:36 kloeri Exp $
SLOT="0"
IUSE=""
