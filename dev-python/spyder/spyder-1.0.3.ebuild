...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/spyder/Attic/spyder-1.0.3.ebuild,v 1.1 2010/03/30 02:32:15 grozin Exp $
EAPI=2
NEED_PYTHON=2.5
inherit distutils
