...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/spyder/Attic/spyder-1.0.1.ebuild,v 1.1 2009/11/10 16:38:26 grozin Exp $
EAPI=2
NEED_PYTHON=2.5
inherit distutils
