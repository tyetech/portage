...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/gconf-python/Attic/gconf-python-2.26.1.ebuild,v 1.5 2009/10/24 16:29:27 nixnut Exp $
