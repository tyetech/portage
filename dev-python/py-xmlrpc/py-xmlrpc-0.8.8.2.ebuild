...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/py-xmlrpc/Attic/py-xmlrpc-0.8.8.2.ebuild,v 1.5 2002/10/04 05:26:47 vapier Exp $
S=${WORKDIR}/${P}
