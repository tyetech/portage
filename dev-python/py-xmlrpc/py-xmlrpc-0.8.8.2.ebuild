...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/py-xmlrpc/Attic/py-xmlrpc-0.8.8.2.ebuild,v 1.7 2002/12/09 04:21:13 manson Exp $
S=${WORKDIR}/${P}
