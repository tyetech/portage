...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/py-xmlrpc/Attic/py-xmlrpc-0.8.8.2.ebuild,v 1.3 2002/07/30 00:50:10 george Exp $
S=${WORKDIR}/${P}
