...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/py-xmlrpc/Attic/py-xmlrpc-0.8.8.2.ebuild,v 1.2 2002/07/11 06:30:24 drobbins Exp $
S=${WORKDIR}/${P}
