...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/pythonmagick/Attic/pythonmagick-0.6.ebuild,v 1.1 2006/10/01 13:18:54 dev-zero Exp $
...
RDEPEND=">=media-gfx/imagemagick-1.1.7
		>=dev-libs/boost-1.34_pre20060930"
DEPEND="${RDEPEND}
		dev-util/scons"
