...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-python/cvs-repo/gentoo-x86/dev-python/ipython/Attic/ipython-0.7.3-r1.ebuild,v 1.1 2007/02/13 19:02:30 dev-zero Exp $
