...
# $Header: /usr/local/ssd/gentoo-x86/output/app-backup/cvs-repo/gentoo-x86/app-backup/amanda/Attic/amanda-2.6.0_p2-r2.ebuild,v 1.1 2008/09/19 19:34:30 robbat2 Exp $
...
IUSE="berkdb debug gdbm minimal s3 samba xfs kerberos"
...
src_compile() {
	...
	myconf="${myconf} `use_enable s3 devpay`"
