...
# $Header: /usr/local/ssd/gentoo-x86/output/app-shells/cvs-repo/gentoo-x86/app-shells/bash-completion/Attic/bash-completion-1.0-r5.ebuild,v 1.6 2009/09/19 15:53:17 nixnut Exp $
