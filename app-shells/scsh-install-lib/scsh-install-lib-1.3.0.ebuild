...
# $Header: /usr/local/ssd/gentoo-x86/output/app-shells/cvs-repo/gentoo-x86/app-shells/scsh-install-lib/scsh-install-lib-1.3.0.ebuild,v 1.1 2006/01/05 18:14:14 mkennedy Exp $
