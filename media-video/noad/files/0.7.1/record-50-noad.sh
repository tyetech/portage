# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/0.7.1/Attic/record-50-noad.sh,v 1.2 2010/03/21 21:18:52 hd_brummy Exp $
#
