# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/Attic/record-20-noad.sh,v 1.1 2006/03/26 23:03:13 hd_brummy Exp $
#
