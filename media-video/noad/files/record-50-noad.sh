# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/record-50-noad.sh,v 1.1 2012/07/04 21:33:43 hd_brummy Exp $
#
