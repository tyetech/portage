# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/0.6.0-r5/Attic/record-50-noad.sh,v 1.1 2006/10/07 11:19:01 zzam Exp $
#
