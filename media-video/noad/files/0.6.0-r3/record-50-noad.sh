# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/0.6.0-r3/Attic/record-50-noad.sh,v 1.2 2006/06/24 08:58:53 zzam Exp $
#
