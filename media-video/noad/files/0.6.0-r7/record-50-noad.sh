# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/0.6.0-r7/Attic/record-50-noad.sh,v 1.5 2007/06/12 16:04:19 zzam Exp $
#
