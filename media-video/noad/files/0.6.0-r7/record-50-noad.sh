# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/noad/files/0.6.0-r7/Attic/record-50-noad.sh,v 1.2 2006/12/28 21:00:47 zzam Exp $
#
