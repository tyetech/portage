...
# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/darwin-streaming-server/Attic/darwin-streaming-server-5.0.1.1.ebuild,v 1.2 2004/06/25 00:38:18 agriffis Exp $
