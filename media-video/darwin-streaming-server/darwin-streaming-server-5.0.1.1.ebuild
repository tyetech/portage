...
# $Header: /usr/local/ssd/gentoo-x86/output/media-video/cvs-repo/gentoo-x86/media-video/darwin-streaming-server/Attic/darwin-streaming-server-5.0.1.1.ebuild,v 1.4 2004/11/03 06:49:22 eradicator Exp $
