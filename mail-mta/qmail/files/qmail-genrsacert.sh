#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail/files/Attic/qmail-genrsacert.sh,v 1.5 2006/01/20 21:45:16 hansmi Exp $
