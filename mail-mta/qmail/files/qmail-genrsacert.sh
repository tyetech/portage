#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail/files/Attic/qmail-genrsacert.sh,v 1.4 2005/06/12 19:35:43 hansmi Exp $
