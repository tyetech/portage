#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail/files/Attic/qmail-genrsacert.sh,v 1.1 2004/05/30 10:50:13 robbat2 Exp $
