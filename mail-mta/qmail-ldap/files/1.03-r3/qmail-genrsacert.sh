#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail-ldap/files/1.03-r3/Attic/qmail-genrsacert.sh,v 1.2 2004/07/18 03:27:44 dragonheart Exp $
