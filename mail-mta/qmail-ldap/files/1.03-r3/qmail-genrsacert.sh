#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail-ldap/files/1.03-r3/Attic/qmail-genrsacert.sh,v 1.1 2004/05/30 10:52:45 robbat2 Exp $
