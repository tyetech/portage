#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail-ldap/files/Attic/qmail-genrsacert.sh,v 1.1 2007/06/16 13:48:10 hollow Exp $
