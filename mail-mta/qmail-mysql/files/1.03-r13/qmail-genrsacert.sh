#!/bin/bash
# $Header: /usr/local/ssd/gentoo-x86/output/mail-mta/cvs-repo/gentoo-x86/mail-mta/qmail-mysql/files/1.03-r13/Attic/qmail-genrsacert.sh,v 1.2 2004/07/18 03:28:23 dragonheart Exp $
