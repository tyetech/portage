...
# $Header: /usr/local/ssd/gentoo-x86/output/net-nds/cvs-repo/gentoo-x86/net-nds/gosa-plugin-samba/gosa-plugin-samba-2.6.10.ebuild,v 1.1 2010/07/29 10:01:12 dev-zero Exp $
