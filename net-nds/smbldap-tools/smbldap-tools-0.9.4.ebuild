...
# $Header: /usr/local/ssd/gentoo-x86/output/net-nds/cvs-repo/gentoo-x86/net-nds/smbldap-tools/Attic/smbldap-tools-0.9.4.ebuild,v 1.2 2007/12/24 10:49:20 dev-zero Exp $
