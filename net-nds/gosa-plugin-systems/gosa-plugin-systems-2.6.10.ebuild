...
# $Header: /usr/local/ssd/gentoo-x86/output/net-nds/cvs-repo/gentoo-x86/net-nds/gosa-plugin-systems/gosa-plugin-systems-2.6.10.ebuild,v 1.1 2010/08/18 15:05:33 dev-zero Exp $
