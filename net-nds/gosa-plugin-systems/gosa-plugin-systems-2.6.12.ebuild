...
# $Header: /usr/local/ssd/gentoo-x86/output/net-nds/cvs-repo/gentoo-x86/net-nds/gosa-plugin-systems/gosa-plugin-systems-2.6.12.ebuild,v 1.1 2011/03/01 06:48:16 dev-zero Exp $
