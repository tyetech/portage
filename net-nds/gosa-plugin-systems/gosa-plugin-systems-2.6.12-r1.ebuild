...
# $Header: /usr/local/ssd/gentoo-x86/output/net-nds/cvs-repo/gentoo-x86/net-nds/gosa-plugin-systems/gosa-plugin-systems-2.6.12-r1.ebuild,v 1.1 2011/04/13 12:41:05 dev-zero Exp $
