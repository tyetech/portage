...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-libs/cvs-repo/gentoo-x86/dev-libs/klibc/klibc-1.5.23.ebuild,v 1.1 2011/07/19 22:17:37 radhermit Exp $
...
src_unpack() {
	...
	epatch "${FILESDIR}"/${PN}-1.5.23-parallel-make.patch
}
