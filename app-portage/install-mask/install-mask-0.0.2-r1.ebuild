...
# $Header: /usr/local/ssd/gentoo-x86/output/app-portage/cvs-repo/gentoo-x86/app-portage/install-mask/install-mask-0.0.2-r1.ebuild,v 1.2 2012/09/07 10:47:31 mgorny Exp $
