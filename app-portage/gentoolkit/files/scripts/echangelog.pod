...
parsed from skel.ebuild.
  ...
  +# $Header: /usr/local/ssd/gentoo-x86/output/app-portage/cvs-repo/gentoo-x86/app-portage/gentoolkit/files/scripts/Attic/echangelog.pod,v 1.1 2003/08/15 12:23:44 lanius Exp $
  +
