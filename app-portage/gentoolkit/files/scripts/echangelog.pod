...
parsed from skel.ebuild.
  ...
  +# $Header: /usr/local/ssd/gentoo-x86/output/app-portage/cvs-repo/gentoo-x86/app-portage/gentoolkit/files/scripts/Attic/echangelog.pod,v 1.2 2004/01/07 21:05:00 agriffis Exp $
  +
