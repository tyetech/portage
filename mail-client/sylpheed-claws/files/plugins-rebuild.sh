...
# $Header: /usr/local/ssd/gentoo-x86/output/mail-client/cvs-repo/gentoo-x86/mail-client/sylpheed-claws/files/Attic/plugins-rebuild.sh,v 1.1 2006/10/26 14:39:21 genone Exp $
#!/bin/bash
