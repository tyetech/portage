...
# $Header: /usr/local/ssd/gentoo-x86/output/mail-client/cvs-repo/gentoo-x86/mail-client/sylpheed-claws/files/Attic/plugins-rebuild.sh,v 1.2 2007/04/12 09:37:03 ticho Exp $
#!/bin/bash
