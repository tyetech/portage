...
# $Header: /usr/local/ssd/gentoo-x86/output/mail-client/cvs-repo/gentoo-x86/mail-client/claws-mail/files/Attic/plugins-rebuild.sh,v 1.3 2008/06/11 22:48:14 opfer Exp $
#!/bin/bash
