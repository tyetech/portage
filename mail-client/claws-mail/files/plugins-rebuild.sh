...
# $Header: /usr/local/ssd/gentoo-x86/output/mail-client/cvs-repo/gentoo-x86/mail-client/claws-mail/files/Attic/plugins-rebuild.sh,v 1.1 2006/12/08 11:07:55 genone Exp $
#!/bin/bash
