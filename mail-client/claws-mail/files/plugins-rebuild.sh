...
# $Header: /usr/local/ssd/gentoo-x86/output/mail-client/cvs-repo/gentoo-x86/mail-client/claws-mail/files/Attic/plugins-rebuild.sh,v 1.2 2006/12/19 18:30:06 ticho Exp $
#!/bin/bash
