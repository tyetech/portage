...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-devel/cvs-repo/gentoo-x86/sys-devel/automake-wrapper/files/Attic/am-wrapper-1.sh,v 1.2 2004/11/14 05:46:07 vapier Exp $
