...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-devel/cvs-repo/gentoo-x86/sys-devel/automake-wrapper/files/Attic/am-wrapper-2.sh,v 1.2 2006/11/10 00:04:41 vapier Exp $
