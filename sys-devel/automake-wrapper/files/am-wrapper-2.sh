...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-devel/cvs-repo/gentoo-x86/sys-devel/automake-wrapper/files/Attic/am-wrapper-2.sh,v 1.1 2006/10/16 01:38:59 vapier Exp $
