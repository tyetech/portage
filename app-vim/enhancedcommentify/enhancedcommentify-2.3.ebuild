...
# $Header: /usr/local/ssd/gentoo-x86/output/app-vim/cvs-repo/gentoo-x86/app-vim/enhancedcommentify/enhancedcommentify-2.3.ebuild,v 1.1 2008/04/16 09:03:46 hawking Exp $
