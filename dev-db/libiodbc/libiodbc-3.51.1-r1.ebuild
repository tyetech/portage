...
# $Header: /usr/local/ssd/gentoo-x86/output/dev-db/cvs-repo/gentoo-x86/dev-db/libiodbc/Attic/libiodbc-3.51.1-r1.ebuild,v 1.1 2004/02/01 12:29:11 tantive Exp $
S=${WORKDIR}/${P}
