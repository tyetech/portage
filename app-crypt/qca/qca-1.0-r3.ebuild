...
# $Header: /usr/local/ssd/gentoo-x86/output/app-crypt/cvs-repo/gentoo-x86/app-crypt/qca/Attic/qca-1.0-r3.ebuild,v 1.1 2008/01/18 16:44:57 ingmar Exp $

inherit eutils qt3

DESCRIPTION="Qt Cryptographic Architecture (QCA)"
HOMEPAGE="http://delta.affinix.com/qca/"
SRC_URI="http://delta.affinix.com/${PN}/${P}.tar.bz2"
