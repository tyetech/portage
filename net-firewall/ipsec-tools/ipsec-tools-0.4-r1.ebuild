...
# $Header: /usr/local/ssd/gentoo-x86/output/net-firewall/cvs-repo/gentoo-x86/net-firewall/ipsec-tools/Attic/ipsec-tools-0.4-r1.ebuild,v 1.1 2005/03/14 19:08:05 latexer Exp $
