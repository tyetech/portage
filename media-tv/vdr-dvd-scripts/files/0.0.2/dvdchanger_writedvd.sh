#!/bin/sh
#
# $Header: /usr/local/ssd/gentoo-x86/output/media-tv/cvs-repo/gentoo-x86/media-tv/vdr-dvd-scripts/files/0.0.2/Attic/dvdchanger_writedvd.sh,v 1.1 2006/07/09 14:20:32 zzam Exp $
#
