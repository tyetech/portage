...
# $Header: /usr/local/ssd/gentoo-x86/output/sys-freebsd/cvs-repo/gentoo-x86/sys-freebsd/freebsd-lib/Attic/freebsd-lib-7.2.ebuild,v 1.4 2009/09/19 19:52:19 aballier Exp $
