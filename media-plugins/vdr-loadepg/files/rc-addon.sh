# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-loadepg/files/rc-addon.sh,v 1.1 2006/08/12 19:31:21 hd_brummy Exp $
#
