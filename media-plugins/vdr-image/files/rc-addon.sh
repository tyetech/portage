# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-image/files/rc-addon.sh,v 1.1 2006/01/04 17:03:52 hd_brummy Exp $
#
