# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-vdrrip/files/rc-addon.sh,v 1.1 2006/10/13 20:11:50 zzam Exp $
#
