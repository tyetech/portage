# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-vdrcd/files/rc-addon.sh,v 1.1 2006/01/29 21:36:07 hd_brummy Exp $
#
