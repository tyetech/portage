# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-vdrmanager/files/Attic/rc-addon.sh,v 1.3 2012/03/02 23:33:49 hd_brummy Exp $
#
