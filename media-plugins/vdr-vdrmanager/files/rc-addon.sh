# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-vdrmanager/files/Attic/rc-addon.sh,v 1.2 2012/03/02 22:14:14 hd_brummy Exp $
#
