# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-vdrmanager/files/Attic/rc-addon.sh,v 1.1 2012/02/24 21:44:54 hd_brummy Exp $
#
