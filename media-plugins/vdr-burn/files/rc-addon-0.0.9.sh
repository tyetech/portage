# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/Attic/rc-addon-0.0.9.sh,v 1.2 2007/04/17 12:40:40 zzam Exp $
#
