# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/Attic/rc-addon-0.0.9.sh,v 1.1 2006/05/21 12:36:33 hd_brummy Exp $
#
