# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/rc-addon.sh,v 1.1 2006/03/05 21:01:00 hd_brummy Exp $
#
