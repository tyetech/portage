# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/0.1.0_pre21/Attic/rc-addon.sh,v 1.3 2009/03/12 02:18:31 hd_brummy Exp $
#
