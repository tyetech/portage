# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/0.1.0_pre21/Attic/rc-addon.sh,v 1.2 2007/05/22 17:40:56 zzam Exp $
#
