# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-burn/files/0.1.0_pre21/Attic/rc-addon.sh,v 1.1 2007/05/07 10:26:31 hd_brummy Exp $
#
