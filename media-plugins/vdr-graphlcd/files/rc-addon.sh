...
#
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-graphlcd/files/rc-addon.sh,v 1.1 2006/01/08 15:36:55 hd_brummy Exp $
