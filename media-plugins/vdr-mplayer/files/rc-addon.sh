# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-mplayer/files/Attic/rc-addon.sh,v 1.1 2006/01/08 21:37:58 hd_brummy Exp $
#
