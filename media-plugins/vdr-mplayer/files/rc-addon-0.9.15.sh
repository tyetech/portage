# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-mplayer/files/rc-addon-0.9.15.sh,v 1.1 2007/05/15 12:51:41 zzam Exp $
#
