...
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/rev-plugins/Attic/rev-plugins-0.2.1.ebuild,v 1.7 2004/09/01 17:37:39 eradicator Exp $
#
MY_P=${P/rev/REV}
