...
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/rev-plugins/Attic/rev-plugins-0.2.1.ebuild,v 1.6 2004/07/04 20:20:45 fvdpol Exp $
#
MY_P=${P/rev/REV}
