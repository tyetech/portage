...
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/rev-plugins/Attic/rev-plugins-0.2.1.ebuild,v 1.8 2005/09/04 09:59:25 flameeyes Exp $
#
MY_P=${P/rev/REV}
