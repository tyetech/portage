...
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/rev-plugins/Attic/rev-plugins-0.3.1.ebuild,v 1.1 2005/10/10 19:04:22 fvdpol Exp $
#
MY_P=${P/rev/REV}
