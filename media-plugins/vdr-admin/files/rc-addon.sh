# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-admin/files/rc-addon.sh,v 1.1 2006/03/15 18:13:03 hd_brummy Exp $
#
