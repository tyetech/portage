...
# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-pin/Attic/vdr-pin-0.0.15.ebuild,v 1.1 2006/05/01 12:07:08 hd_brummy Exp $
RESTRICT=nomirror
inherit vdr-plugin
