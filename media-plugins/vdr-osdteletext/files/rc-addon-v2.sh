# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-osdteletext/files/Attic/rc-addon-v2.sh,v 1.1 2012/04/18 17:33:35 hd_brummy Exp $
#
