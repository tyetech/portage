# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-weatherng/files/rc-addon-0.0.8.sh,v 1.1 2006/03/18 16:44:06 hd_brummy Exp $
#
