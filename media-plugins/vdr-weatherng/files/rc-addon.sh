# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-weatherng/files/Attic/rc-addon.sh,v 1.1 2006/03/07 23:27:21 hd_brummy Exp $
#
