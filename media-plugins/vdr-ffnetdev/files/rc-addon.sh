# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-ffnetdev/files/rc-addon.sh,v 1.1 2006/04/02 15:50:28 hd_brummy Exp $
#
