# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-skinelchi/files/rc-addon-0.1.1_pre2-r1.sh,v 1.2 2007/04/17 12:41:15 zzam Exp $
#
