# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-skinelchi/files/rc-addon-0.1.1_pre2-r1.sh,v 1.1 2006/09/19 15:39:58 hd_brummy Exp $
#
