# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-streamdev/files/rc-addon-0.5.0.sh,v 1.1 2011/01/17 17:07:34 hd_brummy Exp $
#
