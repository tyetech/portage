# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-skinsoppalusikka/files/Attic/rc-addon-1.0.1.sh,v 1.1 2006/07/21 21:40:48 hd_brummy Exp $
#
