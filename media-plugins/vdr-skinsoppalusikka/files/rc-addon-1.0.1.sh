# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-skinsoppalusikka/files/Attic/rc-addon-1.0.1.sh,v 1.3 2006/09/29 21:51:58 hd_brummy Exp $
#
