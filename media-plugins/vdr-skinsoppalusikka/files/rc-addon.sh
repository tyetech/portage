# $Header: /usr/local/ssd/gentoo-x86/output/media-plugins/cvs-repo/gentoo-x86/media-plugins/vdr-skinsoppalusikka/files/Attic/rc-addon.sh,v 1.1 2006/03/06 19:59:21 hd_brummy Exp $
#
